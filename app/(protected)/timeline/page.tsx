...
export default function PetTimelinePage() {
  ...
  if (isLoading) {
    return (
      <div className="max-w-5xl mx-auto flex flex-col items-center justify-center min-h-[400px] p-8">
        <motion.div
  ...
  if (error || !pet) {
    return (
      <motion.div
        className="max-w-5xl mx-auto text-center p-8 text-destructive"
  ...
  return (
    ...
    >
      ...
      >
        <Button variant="outline" size="sm" onClick={resetActivePet}>
          Cambiar mascota
        </Button>
      </TimelineHeader>
      <TimelineEntriesList
