...
export function MedicationsTable() {
  ...
  const medications = useHealth((state) => state.medications).filter(
        ...
        <Table>
          ...
          <TableBody>
            <AnimatePresence mode="wait">
              {currentMedications.map((dose, index) => (
                <motion.tr
          ...
          <TableFooter>
            <TableRow>
              ...
              >
                ...
                {Math.min(endIndex, medications.length)} de {medications.length}{" "}
                medicaciones
              </TableCell>
            </TableRow>
          </TableFooter>
