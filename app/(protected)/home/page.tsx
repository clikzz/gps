...
export default function Home() {
  ...
  if (error) {
    return <div className="flex min-h-screen items-center justify-center text-red-500">Error al cargar el perfil.</div>
  }
        ...
        <CardContent className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center p-0">
          <div className="flex justify-center lg:justify-start">
            ...
            <Image
              ...
              src={activePet.photo_url || "/placeholder.svg?height=400&width=400"}
              width={400}
              height={400}
          ...
          <div className="flex flex-col justify-center space-y-6 text-center lg:text-left">
            ...
            >
              Es un <span className="font-medium">{translateSpecies(activePet.species)}</span>.
            </p>
            <p
            ...
            {activePet.date_of_birth && (
              <p className="text-sm text-muted-foreground">
                Nacido el {new Date(activePet.date_of_birth).toLocaleDateString("es-ES")}
              </p>
            )}
